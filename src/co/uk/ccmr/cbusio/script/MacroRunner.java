...
public class MacroRunner implements Runnable, CbusReceiveListener, MessageSource {
	...
	public MacroRunner(ASTMacro macro, CbusDriver driver, ScriptHandler scriptHander, JFrame frame, StyledDocument log) {
		this.driver = driver;
		this.frame = frame;
		this.macro = macro;
	}
	...
	public void run() {
		...
		ScriptInterpreter si = new ScriptInterpreter(driver, scriptHandler, this, frame, null, log);
		si.visit(macro, null);
